...
public class DataResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static DataResponse fromByteBuffer(
   ...
   * @return A new DataResponse RecordBuilder
   */
  public static name.mrkandreev.avro.DataResponse.Builder newBuilder(name.mrkandreev.avro.DataResponse.Builder other) {
    if (other == null) {
      return new name.mrkandreev.avro.DataResponse.Builder();
    } else {
   ...
   * @return A new DataResponse RecordBuilder
   */
  public static name.mrkandreev.avro.DataResponse.Builder newBuilder(name.mrkandreev.avro.DataResponse other) {
    if (other == null) {
      return new name.mrkandreev.avro.DataResponse.Builder();
    } else {
      return new name.mrkandreev.avro.DataResponse.Builder(other);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DataResponse>
    WRITER$ = (org.apache.avro.io.DatumWriter<DataResponse>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DataResponse>
    READER$ = (org.apache.avro.io.DatumReader<DataResponse>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<name.mrkandreev.avro.DataResponseValue>((int)size0, SCHEMA$.getField("values").schema());
        this.values = a0;
      } else a0.clear();
      SpecificData.Array<name.mrkandreev.avro.DataResponseValue> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<name.mrkandreev.avro.DataResponseValue>)a0 : null);
