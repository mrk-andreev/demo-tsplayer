...
build_application:
	cd tsplayer-application && ./mvnw clean package -Dquarkus.container-image.build=true -Dquarkus.container-image.name=demo-tsplayer -Dquarkus.container-image.tag=latest -Pnative
